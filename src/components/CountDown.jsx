...
const CountDown = () => {
  ...
  const TimeBox = ({ val }) => (
    <div className="bg-[#2d2d2d] text-white text-2xl md:text-3xl font-mono font-bold py-2 px-3 rounded-md shadow-inner border border-gray-600">
      {val}
    </div>
  );

  return (
    <div className="flex items-center gap-4 justify-center py-6" dir="ltr">
        {/* ساعت */}
