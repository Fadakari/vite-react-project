...
const JobCard = ({ title, description, image }) => {
  return (
    <div className="flex flex-col items-center w-full">
      {/* بخش تصویر */}
      <div className="w-full h-48 bg-gray-500 rounded-3xl overflow-hidden shadow-md">
        {image ? (
      ...
      {/* بخش توضیحات و دکمه */}
      <div className="w-full bg-gray-50 pt-10 pb-6 px-4 -mt-6 rounded-b-[2rem] rounded-t-lg shadow-sm text-center border border-gray-100 flex flex-col items-center gap-4">
        <p className="text-xs text-gray-500 leading-6 px-2 line-clamp-3">
          {description}
        </p>
